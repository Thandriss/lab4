...
import makhonko.lab3_5.MainActivity
...
class Tests {
    ...
    fun SecondTest1() {
        ...
        Espresso.onView(withId(R.id.bnToSecond)).perform(ViewActions.click())
        Espresso.onView(withId(R.id.fragment2)).check(ViewAssertions.matches(isDisplayed()))
        Espresso.onView(withId(R.id.nav_host_fragment_activity_main)).check(ViewAssertions.matches(isDisplayed()))//была ошибка в вёрстке
    }
